...
exec usp_createEmployee 'Tasos','Bakasetas',27
...
create function getEmployeeAvgAges()
returns int 
as
begin
...
create procedure usp_deleteEmployeeByAge
as
begin 
	declare @avgAge int = (select dbo.getEmployeeAvgAges())
	delete from Employees where [Age] > @avgAge
end


exec usp_deleteEmployeeByAge
